"""
Django settings for chatMessenger project.
...
SECRET_KEY = '+wew66(_(uz%g%x%q(=vg6f++q^qn^e_a4-v0^&=og_f$#*b8l'
...
ROOT_URLCONF = 'chatMessenger.urls'
...
WSGI_APPLICATION = 'chatMessenger.wsgi.application'
